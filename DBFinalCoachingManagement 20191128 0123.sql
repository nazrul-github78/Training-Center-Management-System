...
INSERT INTO `fund` (`f_id`,`description`,`income`,`expense`) VALUES 
 (1,'Student Payment Income',115000,0),
 (2,'Teacher Payment Expense',0,90000),
 (3,'Other Expense',0,1100);
...
INSERT INTO `get_payment` (`p_id`,`s_id`,`name`,`p_month`,`amount`,`p_date`) VALUES 
 (1,1,'Sayem','July',50000,'2019-01-01'),
 (3,3,'Sayma','july',35000,'2019-02-01'),
 (4,2,'Sajid','july',30000,'2019-07-01');
...
INSERT INTO `teacher_payment` (`tp_id`,`t_id`,`name`,`p_month`,`amount`,`p_date`) VALUES 
 (1,1,'Mahbub Sir','january',30000,'2019-01-01'),
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `delStudentPayment`(sid integer)
BEGIN
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `delTeacherPayment`(tid integer, mnth varchar(40))
BEGIN
Delete from teacher_payment
where t_id=tid && p_month=mnth;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `upStudentPayment`(id integer, nam VARCHAR(30), mnth varchar(30), amnt double, dt varchar(11))
BEGIN
update get_payment
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `upTeacherPayment`(tid integer, nam varchar(40), pmnth varchar(40), amnt double, pdt date)
BEGIN
update teacher_payment
set name=nam, p_month=pmnth, amount=amnt, p_date=pdt
where t_id=tid && p_month=pmnth;
END $$
/*!50003 SET SESSION SQL_MODE=@TEMP_SQL_MODE */  $$
