 ...
 * @author Sayem R41
 */
public class TraineePayment extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cName.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tId, 0, 263, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        jLabel10.setText("Get Payment from Trainees");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        rcpt.lType.setText("Trainee Payment Receipt");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          getPaymentValue();
        if (tId.getSelectedIndex() > 0 && !vName.isEmpty() && !vMonth.isEmpty() && !vAmount.isEmpty() && !vDate.isEmpty()) {
            DataController.updateStudentPayment(vId, vName, vMonth, vAmount, vDate);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        getPaymentValue();
        if (tId.getSelectedIndex() > 0) {
            DataController.deleteStudentPayment(vId);
